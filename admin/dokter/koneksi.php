...
if (isset($_POST['profildokter'])) {
    ...
    $profildokter = mysqli_query($conn, "UPDATE dokter SET nama_dokter ='$nama_dokter',nip = '$nip',tempat_lahir='$tempat_lahir', tanggal_lahir = '$tanggal_lahir', jenis_kelamin = '$jenis_kelamin', agama = '$agama',alamat= '$alamat', no_telepon = '$no_telepon' WHERE id_dokter= '$id_dokter'");
    if ($profildokter) {
...
if (isset($_POST['tperawat'])) {
    ...
    $addperawat = mysqli_query($conn, "insert into perawat (id_perawat, nama_perawat, tempat_lahir, tanggal_lahir, jenis_kelamin, agama, alamat, no_telepon) values('$id_perawat', '$nama_perawat', '$tempat_lahir', '$tanggal_lahir', '$jenis_kelamin', '$agama', '$alamat', '$no_telepon')");
    if ($addperawat) {
        echo '<script type="text/javascript">alert("Berhasil Tambah Data");</script>';
