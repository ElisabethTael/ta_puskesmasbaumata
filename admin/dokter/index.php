...
$ambil = mysqli_query($conn, "SELECT * FROM dokter WHERE id_dokter = '$id_admin'");
                        ...
                        <form action=" method=" post" enctype="multipart/form-data">
                            ...
                            <div class="card-footer">
                                <marquee direction="up" height="150">
                                    <h3 class="text-center"> <?php echo $fetch['nama_dokter']; ?></h3>
                                </marquee><br>
                            </div>
                        </form>
                    </div>
                                ...
                                <div class="card-body border-top py-0 my-3">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6">
                                            <input type="hidden" name="id_dokter" value="<?= $data['id_dokter']; ?>" id="">
                                            <div class="form-group">
                                                <label for="nip">Nama : </label>
                                                <input type="hidden" name="nip" value="">
                                                <input type="text" name="" id="nip" value="<?= $data['nama_dokter']; ?>" class="form-control" placeholder="Masukan NIP Karyawan" required="reuqired" readonly />
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-6 ">
                                            <div class="form-group">
                                        ...
                                        <div class="col-xs-12 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_dokter" id="nama" value="<?= $data['nama_dokter']; ?>" class="form-control" placeholder="Masukana Nama Lengkap Karyawan" required="reuqired" />
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-6 ">
                                            <div class="form-group">
                                ...
                                <div class="card-footer">
                                    <div class="row w-100">
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-3">
                                            <button style="float: right;" type="submit" name="profildokter" class="btn btn-primary btn-block">Simpan <i class="fa fa-save"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
