...
$ambildata = mysqli_query($conn, "SELECT * FROM dokter WHERE id_dokter = '$dok'");
                ...
                <div class="">
                    <div class="main-menu-header">
                        ...
                        <div class="user-details">
                            <span><?= $fetch['nama_dokter'];  ?></span>
                            <div id="more-details">DOKTER</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="table-responsive p-3">
                            <table class="table align-items-center table-bordered" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    $i = 0;
                                    $ambildataperawat = mysqli_query($conn, "SELECT  * FROM  pasien JOIN regis ON regis.id_pasien   = pasien.id_pasien   WHERE cek =0;  ");
                                    while ($data = mysqli_fetch_assoc($ambildataperawat)) {
                                        $i++;
                                        $id_regis = $data['id_regis'];
                                        $id_pasien = $data['id_pasien'];
                                        $nomor_regis = $data['no_regis'];
                                        $nomor_rekammedis = $data['nomor_rekammedis'];
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <input class="form-control mb-3" type="text" name="nomor_rekam" value="<?php echo $nomor_rekammedis ?>" readonly>
                                                            <label for="">nama pasien </label>
                                                            <input class="form-control mb-3" type="text" name="nama_perawat" value="<?= $nama_pasien ?>" readonly>
                                                            <label for="">keluhan</label>
                                                            <input class="form-control mb-3" type="text" name="tempat_lahir" value="<?= $keluhan ?>" readonly>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select multiple class="form-control" name="id_obat[]" id="exampleFormControlSelect2">
                                                                    <?php $obt = mysqli_query($conn, "SELECT * FROM obat WHERE ketersediaan_obat ='ada' ");
                                                                    while ($ob = mysqli_fetch_assoc($obt)) {
                                                                        # code...
                                                                    ?>
                    ...
                    <?php if (isset($_POST['medis'])) {
                        ...
                        $querytambah = mysqli_query($conn, "UPDATE regis SET keterangan_dokter = '$keterangan_dokter', cek = '1',tanggal_rekammedis = '$tanggal_rekam' WHERE id_regis ='$id_regis' ");


                        $id_obat = $_POST['id_obat'];

                        foreach ($id_obat as $ob) {
                            mysqli_query($conn, "INSERT INTO em_obat VALUES('','$nomor_medis','$ob')");
                        }
