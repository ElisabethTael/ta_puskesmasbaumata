                        ...
                        <div class="table-responsive p-3">
                            <table class="table align-items-center table-bordered" id="dataTable">
                                ...
                                <tbody>
                                    <?php
                                    $i = 0;
                                    $ambildatarekammedis = mysqli_query($conn, "SELECT  * FROM  pasien JOIN regis ON regis.id_pasien   = pasien.id_pasien   WHERE cek = 1 ");
                                    while ($data = mysqli_fetch_array($ambildatarekammedis)) {
                                        $i++;

                                        $no_rekammedis = $data['nomor_rekammedis'];
                                        $nama_pasien = $data['nama_pasien'];
                                        $id_regis = $data['id_regis'];
                                        $keterangan = $data['keterangan_dokter'];
                                        $keterangan_pasien = $data['keterangan_pasien'];
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $nama_pasien ?></td>
                                            <td><?= $keterangan ?></td>
                                            <td><?= $keterangan_pasien ?></td>
                                            <td><?= $keterangan_pasien ?></td>
                                            <td><?= $tanggal_rekammedis ?></td>
                                            <td>

                                                <a class="btn btn-success btn-sm" href="pdfrekam.php?id_regis=<?php echo $id_regis ?>"><i class="fas fa-pen" title="edit"></i></a>
