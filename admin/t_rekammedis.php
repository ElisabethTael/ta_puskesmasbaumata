                        ...
                        <div class="table-responsive p-3">
                            <table class="table align-items-center table-bordered" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    $i = 0;
                                    $ambildatarekammedis = mysqli_query($conn, "SELECT * FROM pasien JOIN regis ON regis.id_pasien = pasien.id_pasien ");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="pdfrekam.php?id_regis=<?php echo $id_regis ?>" class="btn btn-success btn-sm"><i class="fas fa-pen" title="lihat rekam medis"></i></a>
