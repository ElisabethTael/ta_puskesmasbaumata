                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" id="#myBtn"><i class="fas fa-plus"> Data Dokter</i> </h6>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $no_telepon ?></td>
                                            <td><?= $id_poli ?></td>
                                            <td><img src="filedokter/<?= $data['file']; ?>" width="50"></td>

                                            <td>

                                                <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit<?= $id_dokter ?>" id="#myBtn"><i class="fas fa-pen" title="edit"></i></button>
                                                <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?= $id_dokter ?>" id="#myBtn"><i class="fas fa-trash" title="Hapus"></i></button>
                                            </td>
                                        </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="id_poli" id="exampleFormControlSelect1">
                                            <option value=""> Nama Poli && Jenis Dokter</option>
                                            <?Php $datapoli = mysqli_query($conn, "SELECT * FROM  poli");
                                            while ($polidata = mysqli_fetch_assoc($datapoli)) {
                                                # code...
                                            ?>
                                                <option value="<?php echo $polidata['id_poli']; ?>"><?php echo $polidata['nama_poli'] ?> && <?php echo $polidata['jenis_dokter'] ?></option>
