...
<head>
  ...
  <link href="../img/ntt.png" rel="icon">
</head>
<style>
...
<div class="wrapper bg-white animate__animated animate__backInDown" >
  <center><p><img src="../img/p.png" width="160" alt=""></p></center>
    
    <div class="h4 text-muted text-center pt-2">Sistem Informasi Pelayanan PUESKESMAS BAUMATA</div>
    <form class="pt-3" method="post">
        ...
        <div class="form-group py-1 pb-2">
            <div class="input-field"> <span class="fas fa-lock p-2"></span> <input type="text" placeholder="Password......" name="psw" required class=""> <button class="btn bg-white text-muted"> <span class="far fa-eye-slash"></span> </button> </div>
        </div>
       ...
       <center><button class="btn btn-success text-center my-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Back</button></center>
