                        ...
                        <div class="table-responsive p-3">
                            <table class="table align-items-center table-bordered" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    $i = 0;
                                    $ambildatarekammedis = mysqli_query($conn, "SELECT  * FROM pasien JOIN regis ON regis.id_pasien = pasien.id_pasien JOIN perawat ON perawat.id_perawat = regis.id_perawat JOIN poli ON poli.id_poli = regis.id_poli JOIN rekammedis ON rekammedis.id_regis = regis.id_regis  ");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit<?= $id_rekammedis ?>" id="#myBtn"><i class="fas fa-pen" title="edit"></i></button>
                                                <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?= $id_rekammedis ?>" id="#myBtn"><i class="fas fa-trash" title="Hapus"></i></button>
                                            </td>
                                        </tr>
