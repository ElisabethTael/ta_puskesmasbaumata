...
if (isset($_POST['tperawat'])) {
    ...
    // validasi ukuran gambar
    if ($ukuran < 15000000) {
        move_uploaded_file($file_tmp, 'fileperawat/' . $file);



        $addperawat = mysqli_query($conn, "insert into perawat (id_perawat, nama_perawat, tempat_lahir, tanggal_lahir, jenis_kelamin, agama, alamat, no_telepon, file) values('$id_perawat', '$nama_perawat', '$tempat_lahir', '$tanggal_lahir', '$jenis_kelamin', '$agama', '$alamat', '$no_telepon', '$file')");
        if ($addperawat) {
            echo '<script type="text/javascript">alert("Berhasil Tambah Data");</script>';
...
if (isset($_POST['editperawat'])) {
    ...
    if ($_FILES['file']['error'] == 4) {
        ...
        if ($ukuran < 15000000) {
            ...
            $editperawat = mysqli_query($conn, "update perawat set nama_perawat='$nama_perawat',tempat_lahir='$tempat_lahir',tanggal_lahir='$tanggal_lahir',jenis_kelamin='$jenis_kelamin',agama='$agama',alamat='$alamat',no_telepon='$no_telepon',file='$gambarlama' where id_perawat='$id_perawat'");
            if ($editperawat) {
                echo '<script type="text/javascript">alert("Berhasil Edit Data");</script>';
                echo "<script>location= 't_perawat.php'</script>";
            } else {
        ...
        if ($ukuran < 15000000) {
            ...
            $editperawat = mysqli_query($conn, "update perawat set nama_perawat='$nama_perawat',tempat_lahir='$tempat_lahir',tanggal_lahir='$tanggal_lahir',jenis_kelamin='$jenis_kelamin',agama='$agama',alamat='$alamat',no_telepon='$no_telepon',file='$file' where id_perawat='$id_perawat'");
            if ($editperawat) {
                echo '<script type="text/javascript">alert("Berhasil Edit Data");</script>';
                echo "<script>location= 't_perawat.php'</script>";
            } else {
...
if (isset($_POST['hapussejarah'])) {
    $id_sejarah = $_POST['id_sejarah']; //idsejarah

    $file = mysqli_query($conn, "select * from sejarah where id_sejarah='$id_sejarah'");
    $get    = mysqli_fetch_array($file);
    $pdf    = 'filesejarah/' . $get['file'];
    unlink($pdf); //hapus gambar dari folder

    $hapus = mysqli_query($conn, "delete from sejarah where id_sejarah='$id_sejarah'");
    if ($hapus) {
        echo '<script type="text/javascript">alert("Berhasil Delete Data");</script>';
        echo "<script>location= 'sejpemilu.php'</script>";
    }
};
