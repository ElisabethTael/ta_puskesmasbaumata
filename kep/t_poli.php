                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" id="#myBtn"><i class="fas fa-plus"> Data Poli</i> </h6>
                        </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit<?= $id_poli ?>" id="#myBtn"><i class="fas fa-pen" title="edit"></i></button>
                                                <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?= $id_poli ?>" id="#myBtn"><i class="fas fa-trash" title="Hapus"></i></button>
                                            </td>
                                        </tr>
