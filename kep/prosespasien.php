        ...
        <div class="navbar-wrapper  ">
            <div class="navbar-content scroll-div ">
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-lock"></i></span><span class="pcoded-mtext">LIHAT DATA PASIEN</span></a>
                        <ul class="pcoded-submenu">
                            <li><a href="datapasien.php">Pasien</a></li>
                            <li><a href="datapasien.php">proses pasien</a></li>
                        ...
                        <div class="table-responsive p-3">
                            <table class="table align-items-center table-bordered" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    $i = 0;
                                    $ambildataperawat = mysqli_query($conn, "SELECT  * FROM  pasien JOIN regis ON regis.id_pasien = pasien.id_pasien JOIN perawat ON perawat.id_perawat = regis.id_perawat JOIN poli ON poli.id_poli = regis.id_poli ");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $no_telepon ?></td>
                                            <!-- <td>
                                                <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit<?= $id_pasien ?>" id="#myBtn"><i class="fas fa-pen" title="edit"></i></button>
                                                <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?= $id_pasien ?>" id="#myBtn"><i class="fas fa-trash" title="Hapus"></i></button>
                                            </td> -->
                                        </tr>

                                        <!-- Perawat Edit-->
                                        <div class="modal fade" id="edit<?= $id_pasien ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <input type="hidden" class="form-control mb-3" name="id_perawat" value="<?= $id_pasien ?>">
