                        ...
                        <div class="table-responsive p-3">
                            <table class="table align-items-center table-bordered" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    $i = 0;
                                    $ambildataperawat = mysqli_query($conn, "SELECT * FROM  pasien JOIN regis ON regis.id_pasien = pasien.id_pasien  WHERE id_poli = 0;   ");
                                    while ($data = mysqli_fetch_array($ambildataperawat)) {
                                        ...
                                        $keterangan = $data['keterangan_pasien'];
                                        $alamat = $data['alamat'];
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?= $id_regis ?>" id="#myBtn"><i class="fas fa-trash" title="Hapus"></i></button> -->
                                            </td>
                                        </tr>
