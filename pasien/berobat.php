        ...
        <div class="container">
            ...
            <div class="container mt-3">
                ...
                <button type="button" class="btn btn-primary  mb-3" data-toggle="modal" data-target="#exampleModal">
                    <i class="fa fa-plus" aria-hidden="true"></i> Berobat
                </button>
            ...
            <table class="table">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col">tangga berobat</th>
                ...
                <tbody>
                    ...
                    $ambilpasien = mysqli_query($conn, "SELECT * FROM pasien  JOIN regis ON regis.id_pasien = pasien.id_pasien   WHERE pasien.id_pasien = '$dtpas' ");
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $dt['no_regis'] ?></td>
                            <td><?php echo $dt['tanggal_regis']; ?></td>
                            <td> <?php echo $dt['keterangan_pasien']; ?> </td>

                            <td><?php if ($dt['id_poli'] > 0) {  ?>
                                    <a href="poli.php?id_poli=<?php echo $dt['id_poli'] ?>" class="btn btn-primary"> lihat poli </a>
                                <?php   } else {  ?>
                                    <p>data poli belum diproses</p>
                                <?php    } ?>
                            </td>


                            <td><?php if ($dt['id_perawat'] == 0) { ?>
                                    <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#editregis<?= $dt['id_regis'] ?>" id="#myBtn">edit</button>
                                    <button type="submit" name="batal" data-toggle="modal" data-target="#batal<?= $dt['id_regis'] ?>" id="#myBtn" class="btn btn-danger btn-sm"> batalkan proses</button>
                                <?php      } elseif ($dt['id_perawat'] > 0) { ?>
                                    <a class="btn btn-primary" href="pdfrekam.php?id_regis=<?php echo $dt['id_regis']; ?>">rekam medis</a>
                                <?php
                                } else {  ?>
                                    <p class="text-danger"> Data Telah Diproses Oleh petugas</p>
                                <?php  } ?>
                            </td>
                        </tr>
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="" method="post">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <label for="inputEmail4">Nomor Regis</label>
                                                    <input type="text" name="id_regis" value="<?php echo $dt['id_regis'];
                                                                                                ?>" readonly class="form-control" id="inputEmail4">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputPassword4">Tanggal Daftar </label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="keterangan" value="<?php echo $dt['keterangan_pasien']; ?>" class="form-control" id="inputAddress" placeholder="">
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal </button>
                                            <button type="submit" name="ubahberobat" class="btn btn-primary">Simpan </button>
                                        </div>
                                    </form>
                                </div>
                            </div>
