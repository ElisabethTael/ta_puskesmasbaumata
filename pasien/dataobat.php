            ...
            <table class="table">
                ...
                <thead>
                    <tr>
                        ...
                        <th scope="col">Ketersediaan Obat </th>
                ...
                <tbody>
                    ...
                    $i = 1;
                    $ambilpasien = mysqli_query($conn, "SELECT * FROM obat ");
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $dt['dosis_obat']; ?></td>
                            <td><?php echo $dt['cara_pakai']; ?></td>
                            <td><?php echo $dt['ketersediaan_obat']; ?></td>
